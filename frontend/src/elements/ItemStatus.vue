<template>
    ...
    <style scoped>
    .wrapper {
      --font-color-dark: azure;
      --font-color-light: black;
      --bg-color: rgb(158, 11, 23);
      --main-color: rgb(236, 181, 181);
      position: relative;
      width: 367px;
      height: 45px;
