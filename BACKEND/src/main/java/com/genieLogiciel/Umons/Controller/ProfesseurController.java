...
public class ProfesseurController {
    ...
    @PostMapping("/courses")
    public ResponseEntity<List<String>> getCourses(@RequestBody LoginRequest loginRequest) {
    ...
    @PostMapping("/{matricule}/uploadImage")
    public ResponseEntity<String> uploadProfesseurImage(
            @PathVariable Long matricule,
            @RequestParam("file") MultipartFile file) {
        professeurService.uploadProfesseurImage(matricule, file);
        return ResponseEntity.ok("Image uploaded successfully");
    }

    @GetMapping("/{matricule}/image")
    public ResponseEntity<String> getProfesseurImage(@PathVariable Long matricule) {
        return professeurService.getProfesseurImage(matricule);
    }
